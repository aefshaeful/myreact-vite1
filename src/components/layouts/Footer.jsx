    ...
    <>
      <div className="footer w-full px-[80px] pt-[150px] relative h-80 sm:px-8 md:px-16 md:pt-16 gap-8">
        ...
        <nav className="font-semibold text-sm font-sans flex-1">
          <header className="footer title">Clothing</header>
          <a className="text-[#A3A3A3]">Shirts</a>
          <a className="text-[#A3A3A3]">Dress</a>
          <a className="text-[#A3A3A3]">Jacket</a>
          <a className="text-[#A3A3A3]">Slim Fit</a>
        ...
        <nav className="font-semibold text-sm font-sans flex-1">
          ...
          <a className="text-[#A3A3A3]">Stainless Steel</a>
        </nav>
        <nav className="font-semibold text-sm font-sans flex-1">
          <header className="footer title">Electronics</header>
          <a className="text-[#A3A3A3]">External Hard Drive</a>
          <a className="text-[#A3A3A3]">Internal SDD</a>
